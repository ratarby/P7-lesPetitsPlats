...
// Normalize str for all caracters to lower case
function normalizingSTR(str) {
    return str
        .normalize("NFD")
        .replace(/[\u0300-\u036f]/g, "")
        .toLowerCase();
...
// normalize str for all caracters' name to lower case
function normalizingNAME(str) {
    return str
...
function normalizingSEARCH(str) {
    return str
        .normalize("NFD")//renvoyer la forme normalisée Unicode d'une chaîne de caractères
